...
summary(fit2)
```
Based on the models above, insufficient data is acquired to draw a meaningful
conclusion between life expectancy and population size. Conversely, we can 
conclude that there is a negative association between life expectancy and 
infant mortality.
